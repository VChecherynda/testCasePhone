...
const DesignPreview = ({ configuration }: { configuration: Configuration }) => {
  ...
  if (material === "polycarbonate") {
    totalPrice += PRODUCT_PRICES.material.polycabonate;
  }
  ...
  return (
    <>
      ...
      <div className="mt-20 flex flex-col items-center text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-8 md:grid md:gap-x-8 lg:gap-x-12">
        ...
        <div className="mt-6 sm:col-span-9 md:row-end-1">
          ...
          <div className="items-cente mt-3 flex gap-1.5 text-base">
          ...
          <div className="mt-8">
              ...
              <div className="flow-root text-sm">
                ...
                {material === "polycarbonate" ? (
                  <div className="mt-2 flex items-center justify-between py-1">
                    <p className="text-gray-600">Textured finish</p>
                    <p className="font-medium text-gray-900">
                      {formatPrice(PRODUCT_PRICES.material.polycabonate / 100)}
                    </p>
                  </div>
                ) : null}
            ...
            <div className="mt-8 flex justify-end pb-12">
              <Button
                ...
                isLoading={isPending}
                disabled={isPending}
                loadingText="Rederecting"
              >
                Checkout out <ArrowRight className="ml-1.5 inline h-4 w-4" />
              </Button>
            </div>
          </div>
        </div>
